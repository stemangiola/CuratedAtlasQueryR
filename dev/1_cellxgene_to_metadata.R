...
system("cp /vast/scratch/users/shen.m/Census_rerun/census_samples_to_download_FILTERED.parquet /vast/projects/cellxgene_curated/metadata_cellxgenedp_Apr_2024/")

cell_to_refined_sample_from_Mengyuan <- tbl(
  dbConnect(duckdb::duckdb(), dbdir = ":memory:"),
  sql("SELECT * FROM read_parquet('/vast/projects/cellxgene_curated/metadata_cellxgenedp_Apr_2024/census_samples_to_download_FILTERED.parquet')")
) |>
...
job::job({
  ...
  FROM read_parquet('/vast/projects/cellxgene_curated/metadata_cellxgenedp_Apr_2024/census_samples_to_download_FILTERED.parquet')
")
